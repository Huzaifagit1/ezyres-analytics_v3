...
export default function TrendsCards() {
  const [monthly, setMonthly] = useState({ data: [], summary: {} });
  const [weekly, setWeekly] = useState({ data: [], summary: {} });
      ...
      {cards.map((card, index) => {
        ...
        return (
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-1 truncate">
               {total }
            </h2>
