 ...
 * Organized into sections like in the reference image
 */
const navSections = [
  {
    items: [
...
/**
 * Expandable Sidebar Navigation Component
 * 
 * Features:
 * - Collapses to icon-only view by default (64px wide)
 * - Expands to full width (240px) on hover showing labels
 * - Maintains active state highlighting
 * - Smooth animations for expand/collapse
 * - Organized sections with headers
 * 
 * @returns {JSX.Element} - Expandable sidebar navigation
 */
